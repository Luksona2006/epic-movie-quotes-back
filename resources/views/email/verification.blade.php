...
<body>
    <div style="width: auto; background: linear-gradient(187.16deg, #181623 0.07%, #191725 51.65%, #0D0B14 98.75%); padding: 78px 195px;">
        ...
        <div style="margin-top: 73px;">
            ...
            <a style="margin-bottom: 40px;" href="{{ route('verify.verify_email', ['token' => $data['token']]) }}">
                <button
            ...
            <a href="{{ route('verify.verify_email', ['token' => $data['token']]) }} style="text-decoration: none; margin-bottom: 40px;">
